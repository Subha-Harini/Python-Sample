...
cur.execute('create table if not exists bill(billid int(10) primary key,destination_chosen varchar(50),hotel_chosen varchar(50),room_chosen varchar(50),bill_amount int(50))')
...
while ans=='y':
     ...
     if ch=='user':
           ...
           print('|                        1. Book Hotel                                         |')
           print('- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  ')
           print('|                        2. Hotel reviews                                     |')
           print('- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  ')
           print('|                        3. Category reviews                                  |')
           print('- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  ')
           print('|                        4. People interest                                   |')
           print('- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  ')
           print('|                        5.Exit                                               |')
           print('- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  ')
           ...
           if y==1:
               ...
               res=cur.fetchall()
               if res.rowcount==0:
                         print('Hurray!.....Your Destination is not reachable')
               else:
                    print('Alas!......Your Destination is reachable')
                    ...
                    if res.rowcount==0:
                        ...
                        res=cur.fetchall()
                        if res.rowcount==0:
                            print('Alas!......Your room is not available')
                        else:
                            for row in res:
                                tariff = row["tariff"]
                                billAmount = tariff * nd;
                                print('Alas!......Your room is available')                  
                                print('Can we generate the bill? Press 1 for yes and any key for No')
                                b=int(input('enter number of days of stay'))
                                if b == 1:
                                    sql = "INSERT INTO bill (billid, destination_chosen,hotel_chosen,room_chosen,bill_amount) VALUES (%d, %s,%s, %s, %d)"
                                    val = (bid, p, h, r, billAmount)
                                    cur.execute(sql, val)       
                                    con.commit()   
                                    print('Bill Generated successfully')
                                    print('Bill Details:')
                                    print('Bill No: %d' + bid)
                                    print('Destination: %s' + p)
                                    print('Hotel: %s' + h)
                                    print('Room: %s' + r)
                                    print('Bill Amount: %d' + billAmount)
                                    print('Thank you')
